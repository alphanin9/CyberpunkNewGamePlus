...
RED4EXT_C_EXPORT void RED4EXT_CALL Query(PluginInfo* aInfo)
{
    ...
    aInfo->version = RED4EXT_SEMVER_EX(build::c_version.major, build::c_version.minor, build::c_version.patch, RED4EXT_V0_SEMVER_PRERELEASE_TYPE_NONE, 0); // Set your version here.
